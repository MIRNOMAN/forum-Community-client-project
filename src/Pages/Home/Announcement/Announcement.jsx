            ...
            <div className="mt-7">
                {
                    ...
                    <img  className="md:h-[510px] md:relative" src={announcementBanner} alt="" />
                    <div className="md:-mt-[35%] md:absolute">
                       <div className="md:flex gap-6 items-center">
                           <img className="h-24 w-24 rounded-full border-8 border-red-500" src={item?.image} alt="" />
                           <p className="md:text-2xl font-bold Playfair">{item.author_name}</p>
                       </div>
                       <div className="mt-4 ">
                        <h3 className="md:text-2xl font-semibold Playfair">{item.title}</h3>
                        <h1 className="md:w-1/3 mt-7 font-semibold py-2">{item.description}</h1>
                       </div>
                    </div>
                </Container>
                    ))
